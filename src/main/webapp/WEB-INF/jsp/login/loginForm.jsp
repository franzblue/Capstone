...
<div class="wrapper">
    ...
    <form class="p-3 mt-3" action="/login/loginSubmit" method="POST">
        ...
        <div class="form-field d-flex align-items-center"> <span class="fas fa-key"></span> <input type="password" class="form-control" id="passwordId" name="password" placeholder="Password"> </div>
